                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" method="action="{{route('adduser')}}">
                            {{ csrf_field() }}
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group mb-3" id="add_app_div">
                                        <label for="bio_data">Receive todays appointments ? : </label>
                                        <select name="bio_data" class="form-control bio_data" id="app_receive" name="app_receive">
                                            <option value="">Please select</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
