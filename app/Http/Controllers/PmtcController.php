...
class PmtcController extends Controller
{
        ...
        if (Auth::user()->access_level == 'Unit') {
            ...
            ->pluck('name', 'id');
               ...
               // ->where('tbl_appointment.visit_type', '=', 'Scheduled')
                ...
                ->whereNull('tbl_client.hei_no')
                ->where('tbl_appointment.appntmnt_date', '<', Now())
                ->where('tbl_master_facility.unit_id', Auth::user()->unit_id)->where('tbl_master_facility.unit_id', Auth::user()->unit_id)
                ->pluck('count');
    ...
    public function filter_hei_dashboard(Request $request)
    {
        ...
        // ->where('tbl_appointment.visit_type', '=', 'Scheduled')
            ...
            if (!empty($selected_partners)) {
                $toone_booked_heis = $toone_booked_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofour_booked_heis = $tofour_booked_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tonine_booked_heis = $tonine_booked_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofourteen_booked_heis = $tofourteen_booked_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tototal_booked_heis = $tototal_booked_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $toone_scheduled_heis = $toone_scheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofour_scheduled_heis = $tofour_scheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tonine_scheduled_heis = $tonine_scheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofourteen_scheduled_heis = $tofourteen_scheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tototal_scheduled_heis = $tototal_scheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $toone_unscheduled_heis = $toone_unscheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofour_unscheduled_heis = $tofour_unscheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tonine_unscheduled_heis = $tonine_unscheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofourteen_unscheduled_heis = $tofourteen_unscheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tototal_unscheduled_heis = $tototal_unscheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $toone_missed_heis = $toone_missed_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofour_missed_heis = $tofour_missed_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tonine_missed_heis = $tonine_missed_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofourteen_missed_heis = $tofourteen_missed_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tototal_missed_heis = $tototal_missed_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $toone_defaulted_heis = $toone_defaulted_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofour_defaulted_heis = $tofour_defaulted_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tonine_defaulted_heis = $tonine_defaulted_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofourteen_defaulted_heis = $tofourteen_defaulted_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tototal_defaulted_heis = $tototal_defaulted_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $toone_ltfu_heis = $toone_ltfu_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofour_ltfu_heis = $tofour_ltfu_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tonine_ltfu_heis = $tonine_ltfu_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tofourteen_ltfu_heis = $tofourteen_ltfu_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $tototal_ltfu_heis = $tototal_ltfu_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_booked_heis = $count_booked_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_scheduled_heis = $count_scheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_unscheduled_heis = $count_unscheduled_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_deceased_heis = $count_deceased_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_transfer_heis = $count_transfer_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_discharged_heis = $count_discharged_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_missed_heis = $count_missed_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_defaulted_heis = $count_defaulted_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_ltfu_heis = $count_ltfu_heis->where('tbl_partner_facility.unit_id', $selected_partners);
                $count_pcr_heis = $count_pcr_heis->where('tbl_partner_facility.unit_id', $selected_partners);
            }
